...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>${updatemode?'Update':'Add New'} Student</h1>
                </div>
                <div class="col-sm-6">
    ...
    <sform:form cssClass="content" method="post" modelAttribute="studentForm">

                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">${updatemode?'Update':'New'} Student</h3>
                            ...
                            <div class="card-body">
                                <s:hasBindErrors name="studentForm">
                                    <c:if test="${not empty errors.globalError}">
                                        <div class="alert alert-danger"><sform:errors/></div>
                                    </c:if>
                                </s:hasBindErrors>
                                <s:bind path="studentFullName">
                                    <div class="form-group">
                                        <label for="studentFullName" class="${status.error?'text-danger':''}">Full Name</label>
                                        <sform:input path="studentFullName"
                                                     cssClass="form-control ${status.error?'is-invalid':''}"/>
                                        <c:if test="${status.error}">
                                            <small class="text-danger"><sform:errors path="studentFullName"/></small>
                                        </c:if>
                                    </div>
                                </s:bind>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-body">
                                <s:bind path="courses">
                                    <div class="form-group">
                                        <label for="courses" class="${status.error?'text-danger':''}">Courses</label>
                                        <sform:select path="courses"
                                                      cssClass="select2bs4 ${status.error?'is-invalid':''}" multiple="multiple"
                                                      data-placeholder="Select Courses" cssStyle="width: 100%">
                                            <sform:options items="${studentForm.courseOptions}"/>
                                        </sform:select>
                                        <c:if test="${status.error}">
                                            <small class="text-danger"><sform:errors path="courses"/></small>
                                        </c:if>
                                    </div>
                                </s:bind>
        ...
        <div class="row">
            <div class="col-6">
                ...
                <input type="submit" value="${updatemode?'Update':'Add'} Student" class="btn btn-success float-right">
            </div>
        </div>
    </sform:form>
</div>
